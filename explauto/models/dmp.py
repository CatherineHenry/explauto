...
class DmpPrimitive(object):
    def __init__(self, dmps, bfs, used=None, default=None, type="discrete", run_time=2.0, timesteps=100):
        ...
        if type == "discrete":
            ...
            raise ValueError(
                "Invalid type specified. Valid choices \
    ...
    def trajectory(self, m, n_times=1):
        ...
        y, dy, ddy = self.dmp.rollout(timesteps=self.timesteps, tau=1.0)
        self.dmp.cs.run_time /= n_times
        self.dmp.timesteps /= n_times
        return y
